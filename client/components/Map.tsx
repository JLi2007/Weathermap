...
function Zoom({ location,zoom }) {
    const map = useMap();
    map.flyTo(location, zoom,{'duration':1.00});
...
function Map(props){
    ...
    return(
        <MapContainer id="map" className='bottom-container' center={markerPosition} zoom={3} zoomControl={false}>
            <TileLayer
            ...
            <Zoom location={markerPosition} zoom={8}/>
